...
class Settings(BaseSettings):
    ...
    proxx_embed_model: str = Field(default="nomic-embed-text:latest", alias="PROXX_EMBED_MODEL")

    knoxx_admin_url: str = Field(default="http://localhost:5173", alias="KNOXX_ADMIN_URL")
    ...
    proxx_default_model: str = Field(default="gpt-5.4-mini", alias="PROXX_DEFAULT_MODEL")
