...
| `orgs/open-hax/knoxx/specs/epics/knowledge-ops-role-scoped-lakes.md` | superseded split-lake conceptual model |
| `orgs/open-hax/knoxx/specs/epics/knowledge-ops-federated-lakes.md` | superseded split-lake federation language for `devel-*` |
