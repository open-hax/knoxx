...
| `orgs/open-hax/knoxx/specs/archived/reference/knowledge-ops-the-lake.md` | Existing lake architecture |
| `orgs/open-hax/knoxx/specs/epics/knowledge-ops-chat-widget-layers.md` | Existing role/layer architecture |
