...
|------|-----------|--------|--------|--------------|
| 0. Shell Foundation | 4 | 8 | ✅ Complete | Archived under `specs/archived/tasks/workbench/` |
| 1. Dashboard | 3 | 5 | 2/5 complete | Remaining work blocked on P1B |
| 2. Content Editor | 4 | 6 | 3/6 complete | Remaining work blocked on P1B/P3 |
| 3. Review Queue | 3 | 5 | 4/5 complete | Remaining write-back blocked on P1B |
| 4. Memory Inspector | 3 | 5 | Blocked on P1B | P1B |
| 5. Agent Workspace | 3 | 5 | Blocked on P1B | P1B |
| 6. Ops Log | 3 | 4 | ✅ Complete | Archived under `specs/archived/tasks/workbench/` |
| 7. Shared Components | 2 | 2 | ✅ Complete | Archived under `specs/archived/tasks/workbench/` |
| **Total** | **25** | **40** | **23 pts done, 17 pts remaining** | |

**Progress**:
- ✅ Complete: 23 points (Epic 0, Epic 1.1, Epic 2.1, Epic 2.4, Epic 3.1, Epic 3.2, Epic 6, Epic 7)
- 🔒 Remaining: 17 points, all kept under `specs/tasks/workbench/`
- 🗄 Archived: completed Workbench child specs moved to `specs/archived/tasks/workbench/`
...
- [x] 2.4 Content Editor Staged Publish Flow (1 pt)
- [x] 3.1 Review Queue Shell (2 pt)
- [x] 3.2 Review Item Detail (2 pt)
- [x] 6.1 Ops Event Table (2 pt)
- [x] 6.2 Ops Event Detail (1 pt)
- [x] 6.3 Gardens Sub-Tabs (1 pt)
...
- [ ] 4.2 Memory Focal Node View (2 pt)
- [ ] 4.3 Memory History Slider (1 pt)
- [ ] 5.1 Agent Run List (2 pt)
- [ ] 5.2 Agent Run Detail (2 pt)
- [ ] 5.3 Agent Scratchpad (1 pt)

---

## Exit Criteria Checklist

Each active sub-spec tracks its exit criteria in `specs/tasks/workbench/`. Completed sub-specs live in `specs/archived/tasks/workbench/`.

```text
specs/tasks/workbench/
