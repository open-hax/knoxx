...
This report is an inventory and migration design, not a complete implementation. It should be used as the backing document for the epic and subtasks in `specs/epics/knoxx-backend-law-shape-domain-epic.md`.
