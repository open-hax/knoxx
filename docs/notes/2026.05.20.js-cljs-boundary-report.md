...
- [ ] `extern/fastify.cljs` created — _date / commit_
- [ ] `infra/routes/app.cljs` migrated — _date / commit_
- [ ] `infra/routes/tools/proxy.cljs` migrated — _date / commit_
- [ ] `infra/routes/mcp.cljs` migrated — _date / commit_
- [ ] `infra/routes/tools.cljs` migrated — _date / commit_
- [ ] `infra/routes/models.cljs` migrated — _date / commit_
- [ ] `infra/routes/studio.cljs` migrated — _date / commit_
- [ ] `infra/routes/users/admin.cljs` migrated — _date / commit_
