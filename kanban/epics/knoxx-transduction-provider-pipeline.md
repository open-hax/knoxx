...
- `knoxx-translation-config-trusted-auth-context` — derive config GET/PATCH scope only from
  verified session/API-key identity; caller identity headers cannot select a tenant.
