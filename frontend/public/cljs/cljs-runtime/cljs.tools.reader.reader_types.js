...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7859 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7859(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7861 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7861(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7863 = (function (reader,ch){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7863(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7864 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7864(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7868 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7868(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7870 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7870(reader);
}
});
...
var G__7913 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__7914 = s.append(c);
c = G__7913;
s = G__7914;
continue;
}
