...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__8164_SHARP_,p2__8163_SHARP_){
return p2__8163_SHARP_.toUpperCase();
}));
...
var G__8165 = o;
helix.impl.props.goog$module$goog$object.set(G__8165,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__8204 = cljs.core.rest(m);
var G__8205 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8181_SHARP_){
if(cljs.core.map_QMARK_(p1__8181_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__8181_SHARP_);
} else {
return p1__8181_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__8210 = cljs.core.rest(m);
var G__8211 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__8222 = cljs.core.rest(m);
var G__8223 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
