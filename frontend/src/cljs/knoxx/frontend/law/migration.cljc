(ns knoxx.frontend.law.migration
  ...
  (:require [clojure.set :as set]
            ...
            [knoxx.frontend.law.migration-paths :as paths]
            [malli.core :as m]
            [malli.error :as me]))
...
(def contained-path? "Compatibility entry point for path containment." paths/contained-path?)
(def assert-source-root! "Compatibility entry point for source-root admission." paths/assert-source-root!)
(def assert-source-symlink! "Compatibility entry point for contained source links." paths/assert-source-symlink!)
...
(def assert-import-target! "Compatibility entry point for contained imports." paths/assert-import-target!)
(def assert-vite-alias-target! "Compatibility entry point for contained Vite aliases." paths/assert-vite-alias-target!)
