# Fork Tales: Sovereign Shiver

Generated by Knoxx as an OpenUtau singing-project scaffold.

## Files
- `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/fork-tales-sovereign-shiver/fork-tales-sovereign-shiver.ustx` — OpenUtau `.ustx` project
- `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/fork-tales-sovereign-shiver/README.md` — this workflow note
...
## Render workflow
1. Open `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/fork-tales-sovereign-shiver/fork-tales-sovereign-shiver.ustx` in OpenUtau.
