...
## Files
- `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/the-resonance-hunt/the-resonance-hunt.ustx` — OpenUtau `.ustx` project
- `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/the-resonance-hunt/README.md` — this workflow note
...
## Render workflow
1. Open `orgs/open-hax/openplanner/packages/agents/knoxx/uploads/openutau/the-resonance-hunt/the-resonance-hunt.ustx` in OpenUtau.
