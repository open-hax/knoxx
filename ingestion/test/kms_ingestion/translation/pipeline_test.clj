(ns kms-ingestion.translation.pipeline-test
  "Integration tests for the CMS -> publish -> translate pipeline.
   Requires a live OpenPlanner server. Skipped in unit CI.
   Run with: INTEGRATION_TESTS=true clojure -M:test:integration"
  (:require
...
(def ^:private run-integration? (System/getenv "INTEGRATION_TESTS"))
